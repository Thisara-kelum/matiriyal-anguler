...
export class GetDataService {
  ...
  subCategorisFilterData = [
    ...
    { id: 5, categories: ' Petrol Engine Oils', subcategories: 'voliValvne' },
    { id: 6, categories: ' Petrol Engine Oils', subcategories: 'mobil' },
  ...
  categoriesData = [
    {
      ...
      img: '../../assets/images/categoriesimg/image001.png',
      code: ' Petrol Engine Oils',
    },
    {
      id: 2,
      name: 'Home & Furniture',
  ...
  productData = [
    {
      pdId: 8565,
      pdName: "VALVOLINE DIESEL SYNTHETIC 5W40",
      pdDesc: "Valvoline Diesel Synthetic full synthetic engine oil is formulated with high-quality synthetic basestocks and boosted additive system. The hi-performance synthetic technology meets the stringent demands of modern diesel including EGR (Exhaust Gas Reciraculation) engines.",
      pdPrice: 10500,
